            ...
            <div className="flex justify-start sm:justify-end items-center space-x-2">
              ...
              {esAdmin && (
                <>
                  ...
                  <button onClick={() => {
                    console.log('DEBUG: Edit button clicked for evento:', evento);
                    alert('Edit button clicked for: ' + evento.nombre + ' (Admin: ' + esAdmin + ')');
                    onEditar(evento);
                  }} className="p-2 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600 transition-all duration-200 ease-in-out transform hover:scale-110" title="Editar Evento">
