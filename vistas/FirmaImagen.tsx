...
const VistaFirmaImagen: React.FC = () => {
    ...
    const renderContent = () => {
        ...
        if (enviadoConExito) {
             return (
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-700 dark:text-gray-300">La autorización de imagen para el estudiante <span className="font-semibold">{estudiante?.nombres} {estudiante?.apellidos}</span> ya ha sido registrada.</p>
        ...
        return (
            <>
                <div className="text-center">
                    <h2 className="text-3xl font-bold text-tkd-dark dark:text-white">Autorización de Uso de Imagen</h2>
                    <p className="mt-2 text-gray-600 dark:text-gray-400">Para la escuela TaekwondoGa Jog</p>
                </div>
                ...
                <div className="p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-200 dark:border-blue-800">
                    ...
                    <ol className="list-decimal list-inside text-sm text-gray-600 dark:text-gray-300 space-y-1 mt-1">
                        ...
                        <li>Elija si autoriza o no el uso de la imagen.</li>
                        <li>Realice su firma en el recuadro designado.</li>
                        <li>Haga clic en el botón "Guardar y Enviar" para finalizar.</li>
                    </ol>
                </div>
                ...
                <div className="p-4 border-t dark:border-gray-700">
                    <p className="block text-md font-medium text-gray-700 dark:text-gray-300 mb-2">Seleccione una opción:</p>
                    <div className="space-y-2">
                        <label className="flex items-center p-3 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer focus-within:ring-2 focus-within:ring-tkd-blue">
                            <input type="radio" name="autorizacion" value="si" onChange={() => setAutorizacion('si')} className="h-5 w-5 text-tkd-blue focus:ring-tkd-blue border-gray-300"/>
                            <span className="ml-3 text-sm text-gray-800 dark:text-gray-200">Sí autorizo el uso de la imagen y los datos personales del menor bajo los términos descritos.</span>
                        </label>
                        <label className="flex items-center p-3 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer focus-within:ring-2 focus-within:ring-tkd-blue">
                            <input type="radio" name="autorizacion" value="no" onChange={() => setAutorizacion('no')} className="h-5 w-5 text-tkd-blue focus:ring-tkd-blue border-gray-300"/>
                            <span className="ml-3 text-sm text-gray-800 dark:text-gray-200">No autorizo el uso de la imagen del menor, pero sí autorizo el tratamiento de los datos personales para fines administrativos.</span>
                        </label>
                    </div>
                </div>
                ...
                <div>
                 ...
                 <div>
                    <button
                        ...
                        disabled={!firmaRealizada || !autorizacion || enviando}
                    ...
                    >
                        ...
                        <span>{enviando ? 'Enviando...' : 'Guardar y Enviar Autorización'}</span>
                    </button>
                </div>
            </>
        );
