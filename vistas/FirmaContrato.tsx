...
const VistaFirmaContrato: React.FC = () => {
    ...
    const renderContent = () => {
        ...
        if (enviadoConExito) {
             return (
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-green-600 mt-4">¡Contrato Registrado!</h2>
                    <p className="mt-4 text-gray-700 dark:text-gray-300">El contrato de servicios para el estudiante <span className="font-semibold">{estudiante?.nombres} {estudiante?.apellidos}</span> ya ha sido guardado.</p>
        ...
        return (
            <>
                <div className="text-center">
                    <h2 className="text-3xl font-bold text-tkd-dark dark:text-white">Contrato de Servicios</h2>
                ...
                <div>
                 ...
                 <div>
                    ...
                    >
                        ...
                        <span>{enviando ? 'Enviando...' : 'Acepto y Firmo el Contrato'}</span>
                    </button>
                </div>
            </>
        );
