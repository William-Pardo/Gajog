...
export const VistaEventos: React.FC = () => {
  ...
  return (
    <div className="p-8">
      ...
      {esAdmin && modalConfirmacionAbierto && eventoAEliminar && <ModalConfirmacion abierto={modalConfirmacionAbierto} titulo="Confirmar Eliminación" mensaje={`¿Estás seguro de que quieres eliminar el evento "${eventoAEliminar.nombre}"?`} onCerrar={cerrarConfirmacion} onConfirmar={confirmarEliminacion} cargando={cargandoCRUD}/>}
    </div>
  );
};