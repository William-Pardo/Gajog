...
import { VistaEncuentroPublico, VistaEncuentros } from './vistas/Encuentros';
...
const BarraLateral: React.FC<{ estaAbierta: boolean; onCerrar: () => void; onLogout: () => void, usuario: Usuario }> = ({ estaAbierta, onCerrar, onLogout, usuario }) => {
    ...
    const enlaces = [
        ...
        { ruta: "/encuentros", texto: "Encuentros", icono: IconoEventos, rol: RolUsuario.Usuario },
...
const AppRoutes: React.FC = () => {
    ...
    return (
        <ReactRouterDOM.Routes>
            ...
            <ReactRouterDOM.Route path="/encuentro/:idEvento" element={<VistaEncuentroPublico />} />
            ...
            <ReactRouterDOM.Route element={<RutaProtegida><AppLayoutWithData /></RutaProtegida>}>
                ...
                <ReactRouterDOM.Route path="/encuentros" element={<VistaEncuentros />} />
